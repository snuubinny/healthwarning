...
const RecentPostCard = ({ post }) => {
  ...
  return (
    <RecentPostsBox>
      ...
      <InfoBox>
        <SleepInfo>
          <HighLight2>• 수면</HighLight2> 목표 시간 {goalSleep}시간 중 <HighLight>{sleep_time}</HighLight>시간
        </SleepInfo>
        <MedicationInfo>
          <HighLight2>• 복약</HighLight2> 목표 횟수 {goalMedication}회 중 <HighLight>{medication_today}</HighLight>회
        </MedicationInfo>
        <ExerciseInfo>
          <HighLight2>• 운동</HighLight2> 목표 시간 {goalExercise}분 중 <HighLight>{exercise_time}</HighLight>분
        </ExerciseInfo>
        <MealInfo>
          <HighLight2>• 식사</HighLight2> 목표 횟수 {goalMeal}끼 중 <HighLight>{meal_count}</HighLight>끼
        </MealInfo>
      </InfoBox>
    </RecentPostsBox>
  );
